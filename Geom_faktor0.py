...
while i < N:
    ...
    # x_1 = (j-1/2) * 0.055  # Náhodná poloha v první vrstvě detektoru 
    # y_1 = (j-1/2) * 0.055  # Náhodná poloha v první vrstvě detektoru
